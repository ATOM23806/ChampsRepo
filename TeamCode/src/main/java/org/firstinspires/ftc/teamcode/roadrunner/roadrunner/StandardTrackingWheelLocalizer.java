package org.firstinspires.ftc.teamcode.roadrunner.roadrunner;
...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 8.93342298865; //  in; distance between the left and right wheels
    public static double FORWARD_OFFSET = -6.25; // in; offset of the lateral wheel

    private Encoder leftEncoder, rightEncoder, frontEncoder;

    public static double X_MULTIPLIER = 1.01264938761;
    public static double Y_MULTIPLIER = 0.99157070869;
