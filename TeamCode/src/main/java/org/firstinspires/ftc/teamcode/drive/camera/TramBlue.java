...
public class TramBlue implements VisionProcessor {
     ...
     */
    public TramBlue(@NonNull Scalar lower, @NonNull Scalar upper, DoubleSupplier minArea, DoubleSupplier left, DoubleSupplier right) {
